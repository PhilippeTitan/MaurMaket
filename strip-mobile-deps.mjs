...
const backendDeps = ['bcrypt', 'cors', 'dotenv', 'express', 'jsonwebtoken', 'multer', 'pg', 'node-cron', 'nodemailer', 'google-auth-library', 'expo-server-sdk', 'express-rate-limit', 'morgan', '@aws-sdk/client-s3', 'sharp'];
const filtered = {
  name: pkg.name,
  version: pkg.version,
  type: 'module',
