...
export type RootStackParamList = {
  ...
  NatCashPayment: { orderId?: string; pendingId?: string; total: number; sellerName?: string; sellerPhone?: string; sellers?: Array<{ sellerId: string; name: string; phone: string; total: number; items: Array<{ name: string; price: number; quantity: number }> }> };
};
