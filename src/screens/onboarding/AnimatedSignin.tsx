...
const s = StyleSheet.create({
  ...
  providerCard: { width: 120, alignItems: 'center', justifyContent: 'center', paddingVertical: 8 },
  providerIcon: { width: 64, height: 64, borderRadius: 32, alignItems: 'center', justifyContent: 'center', backgroundColor: 'rgba(139,92,246,0.15)', borderWidth: 2, borderColor: 'rgba(139,92,246,0.5)', marginBottom: 8 },
